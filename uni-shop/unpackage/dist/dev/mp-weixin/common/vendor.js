...
/* 5 */
/*!*****************************************!*\
  !*** D:/uni-app小商店/uni-shop/pages.json ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 12 */
/*!******************************************!*\
  !*** D:/uni-app小商店/uni-shop/util/api.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.myRequest = void 0;var BASE_URL = 'https://api-hmugo-web.itheima.net/api/public/v1'; // 请求地址公共部分
var ajaxTimes = 0; // 同时发送异步代码的次数
var myRequest = function myRequest(options) {
  ajaxTimes++; // 调用一次加一 ，调完一次减一  防止同时多次调用函数 加载图标多次出现
  uni.showLoading({ title: "加载中", mask: true }); // 显示加载的图标
  return new Promise(function (resolve, reject) {
    uni.request({
      ...
      fail: function fail(err) {// 失败的回调
        return uni.showToast({
          title: '请求接口失败' });

        reject(err); // Promise失败的回调，返回错误消息
      },
      complete: function complete() {// 接口调用结束的回调函数(无论成功还是失败)
        ajaxTimes--;
        if (ajaxTimes === 0) {
